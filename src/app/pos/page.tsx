      ...
      <div className="flex h-screen flex-col bg-gray-50">
        ...
        >
          <motion.button
            ...
            className="relative rounded-full bg-primary p-4 text-white shadow-lg"
          >
            ...
            {getTotalCartItems() > 0 && (
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-[#D4AF37] text-xs font-bold text-white"
              >
                {getTotalCartItems()}
              </motion.div>
            )}
        ...
        {/* Product Popup - Slide Up from Bottom */}
        <AnimatePresence>
          {selectedProduct && (
            <motion.div
              initial={{ opacity: 0 }}
            ...
            >
              <motion.div
                ...
                className="fixed bottom-0 left-0 right-0 max-h-[85vh] overflow-y-auto rounded-t-3xl bg-white shadow-2xl"
              ...
              >
                ...
                <div className="relative">
                  ...
                  {selectedProduct.badge && (
                    <div className="absolute left-4 top-4 rounded-full bg-[#D4AF37] px-3 py-1 text-xs font-bold text-white shadow-lg">
                      {selectedProduct.badge}
                    </div>
                  )}
                </div>
                  ...
                  <div className="space-y-3 pb-4">
                    {getProductQuantity(selectedProduct.id) === 0 ? (
                      <motion.button
                        ...
                        className="w-full rounded-xl bg-primary py-4 text-lg font-semibold text-white shadow-lg hover:bg-[#B8941F] transition-colors"
                      >
                        Add to Cart
                      </motion.button>
                    ) : (
                      <div className="space-y-3">
                        <div className="flex items-center justify-between rounded-xl bg-[#D4AF37] p-4 text-white shadow-lg">
                          <motion.button
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.9 }}
                        ...
                        {getTotalCartItems() > 0 && (
                          <Button
                            ...
                            className="w-full rounded-xl bg-[#2c375d] py-4 text-lg font-semibold text-white hover:bg-[#1a2440] shadow-lg"
                          >
