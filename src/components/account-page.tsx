...
export default function AccountPage() {
  ...
  <h1 className="text-3xl font-bold text-[#ff734d]">My Account</h1>

  {/* Right section with Bell, Menu, and Profile */}
  <div className="flex items-center gap-4">
    <Bell className="text-[#ff734d] w-6 h-6" />
    <Menu className="text-[#ff734d] w-6 h-6" />
    <Image
      src={Img}
      alt="Profile"
      width={40}
    ...
    />
      ...
      <div className="flex items-center gap-4 px-6 py-4">
        <div className="w-16 h-16 rounded-full bg-[#ff734d] flex items-center justify-center text-white text-3xl font-bold">
          S
        </div>
        <div>
      ...
      <div className="px-6 py-8">
        <button className="w-full py-4 bg-[#ff734d] text-white rounded-full text-xl font-semibold">Share App</button>
      </div>
      <Footer/>
    </div>
  )
